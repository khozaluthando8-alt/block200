...
//const CONTRACT_ADDRESS = "0x0E763c0d3bCdFa4f744B9DE3355B67B3A9b262Ba";
  ...
  require('dotenv').config();
const contractAPI=process.env.CONTRACT_ADDRESS
const URL=process.env.RPC_URL
const pinataAPI=process.env.PINATA_JWT
const key=procese.env.PRIVATE_KEY
     ...
     //  const MASTER_KEY = process.env.MASTER_KEY;
      ...
      import ABI from './abi.js';
       ...
       async function register() {
          ...
          //0xDe42326B4611C6dD3A72E19447F64bC22Bd3aD18
        ...
        function saveSession(key) {
            ...
            setTimeout(() => { window.location.href = "shop2.html"; }, 2000);
        }